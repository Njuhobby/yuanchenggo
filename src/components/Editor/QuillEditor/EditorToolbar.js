...
function EditorToolbar({ id, isSimple, className, toolbarButtonClick }) {
  ...
  return (
    <div className={clsx(classes.root, className)}>
      <div id={id}>
        ...
        <div className="ql-formats">
          {!isSimple && <button className="ql-direction" value="rtl" />}
          {!isSimple && <select className="ql-align" />}
        </div>

        <div className="ql-formats">
          <button className="ql-link" />
          <button className="ql-image" />
          {!isSimple && <button className="ql-video" />}
        </div>

        <div className="ql-formats">
          {!isSimple && <button className="ql-formula" />}
          {!isSimple && <button className="ql-clean" />}
        </div>
